...
import {useContent} from "../../context/AuthContext";
import {validateForm} from "./joinValid";
...
const PASSWORD_REGEX = /^[A-Za-z0-9]{6,}$/; // 알파벳 대소문자&숫자, 길이 최소 6자 이상
const ID_REGEX = /^[a-z0-9A-Z_.]{2,16}$/; // 알파벳 대소문자&숫자&밑줄&마침표, 길이 2~16
